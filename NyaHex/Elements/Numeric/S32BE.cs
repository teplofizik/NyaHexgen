...
namespace NyaHexgen.Elements.Numeric
{
    ...
    public class S32BE : Element
    {
        Int32 Value = 0;

        public S32BE() : base("s32be")
        {
        ...
        {
            data.WriteUInt32BE(offset, (uint)Value);
        }
    }

    public class S32BEFactory : ElementFactory
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        public S32BEFactory() : base("s32be")
        {
